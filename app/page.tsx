    ...
    <main className="min-h-screen bg-[#050B14] text-white">
      ...
      <div className="px-5 mt-6">
        ...
        <div className="rounded-3xl border border-blue-900/30 bg-gradient-to-b from-[#0B1324] to-[#050B14] p-6">
          ...
          <p className="text-slate-400 mt-4 text-sm">
            ...
            Trend Market dan Potensi Bagger
      ...
      <div className="px-5 mt-6">
        ...
        <div className="bg-[#0B1324] border border-blue-900/30 rounded-3xl p-4">
          ...
          <button className="w-full mt-4 bg-gradient-to-r from-cyan-500 to-blue-600 py-4 rounded-xl font-bold flex justify-center items-center gap-2">
      ...
      <div className="px-5 mt-5 grid grid-cols-2 gap-3">
        ...
        <button className="bg-[#111827] border border-slate-700 py-4 rounded-xl flex justify-center items-center gap-2">
        ...
        <button className="bg-gradient-to-r from-blue-500 to-cyan-500 py-4 rounded-xl font-bold flex justify-center items-center gap-2 shadow-lg shadow-blue-500/30">
